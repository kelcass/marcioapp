						...
						<div class="panel-body">
				          ...
				          <form class="form-horizontal" role="form" name="cadastrarEstudante" method="POST" >
							...
							<div class="col-sm-12" >
							  <div class="form-group">
								...
								<div class="col-sm-4">
								BI:
								  <input type="text" class="input-sm form-control" name="biCandidato" maxlength="13" placeholder="BI" required="">
								</div>
							</div>
				         </div>
				          <div class="col-sm-12">
				          ...
				          <div class="col-sm-12">
							  ...
							  <div class="col-sm-4">
								...
								Classe da inscrição:
								  <select class="input sm form-control" name="classe" required>
								  	<option value="">Selecione aqui</option>
									  <option value="8">8º Classe</option>
											<option value="9">9º Classe</option>
							...
							<div class="col-sm-12">
							  ...
							  <div class="col-sm-4">
								Nome da escola:
								  <input type="text" class="input-sm form-control" name="Escola_Saida" maxlength="50" placeholder="Ex: Escola primária dos Limoeiros - Nampula" required>
								</div>
							  <div class="col-sm-2">
								Ano de saida:
								  <input type="text" class="input-sm form-control" name="Ano_Saida" maxlength="4" placeholder="Ex: 2023" required>
								</div>
							  <div class="col-sm-4">
								Classe frequentada:
