...
<?php
	...
	$resultado3 = mysql_query("SELECT * FROM tabela_turma");
	$numTurmas = mysql_num_rows($resultado3);
?>
...
<div class="container-fluid">
	...
	<div class="col col-lg-H col-md-H col-sm-H haggy"  >
            ...
            <?php if($_SESSION['usuarioNivelAcesso']=='1' OR $_SESSION['usuarioNivelAcesso']=='2') {?>
            ...
            <div class="col-md-4">
              ...
              <div class="col-md-4">
               	<div class="alert alert-warning">
    				<h2 align="center">Turmas</h2>
					
    				
					 <center>
    				 <strong><?php echo "".$numTurmas;?></strong> <br>
