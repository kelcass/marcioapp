			...
			<div class="col-sm-12">
			 ...
			 <div class="col-sm-12">
			  <div class="form-group">
				<div class="col-sm-6">
				Celular:
				  <input type="text" class="input sm form-control" name="Contato" value="<?php echo $resultado['Contacto']?>" placeholder="Estado Civil" required="">
				</div>
				<div class="col-sm-6">
				País:
				  <select class="input sm form-control" name="Pais" required="">
				  	<option value="<?php echo $resultado['Pais']?>"><?php echo $resultado['Pais']?></option>
					  <option value="Moçambique">Moçambique
