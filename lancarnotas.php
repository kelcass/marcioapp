...
<?php
	...
	if($_SESSION['usuarioNivelAcesso']=='3' OR $_SESSION['usuarioNivelAcesso']=='2')
        ...
        <div class="panel-heading" >
			...
			<div class="table-responsive">
				...
				while($linhas2 = mysql_fetch_array($resultado)){
					...
					echo "<td><input type='text' size='4.2' maxlength='5' class='form-control' id='texte3' name='texte3' value='".$m->T3."'" ."></td>";
					echo "<td><input type='text' size='4.2' maxlength='5' class='form-control' id='AP' name='AP' value='".$m->AP."'" ."></td>";
					echo "<td>".$m->MT."</td>";
