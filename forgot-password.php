...
$chngpwd1->execute();
echo "<script>alert('passord trocado com sucesso');</script>";
}
else {
echo "<script>alert('Email or numero invalidos');</script>"; 
}
}
...
<head>
    ...
    <title>Forgot Password | SNGN</title>
...
{
alert("os novos passords nao condizem  !!");
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                               <h3 style="font-weight: bold;color: blue">Sistema Nacional de Gestao de Nascimentos</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="">Recuperacao de senha</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-button-pro" style="text-align:center">
                                                ...
                                                <button type="submit" class="login-button login-button-lg" name="submit">Repor</button>

                                            </div>
                                            <p style="text-align:center"><a href="index5.php">Tens uma conta ? Faca Login</a></p>
                                        </div>
