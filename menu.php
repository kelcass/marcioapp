      ...
      <div class="panel navbar with-nav-tabs navbar-fixed-top" >
        <div class="panel-heading" style="background-color:black;">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse">
              ...
              <span class="icon-bar"></span>
                ...
                <a class="navbar-brand" href="inicio.php"><span style="color: #fff; font-size: 24px;  "><label>Escola Secundaria 12 de Outubro-Nampula</label></span></span></a>
          </div> 
          <div class="navbar-collapse collapse" id="navbar-collapse">
                ...
                ?>
    				      <li ><a href="mensagens.php"><span class="" style="color: #ffffff;font-size:18px;"></span></a></li>
                  <?php 
                      } 
