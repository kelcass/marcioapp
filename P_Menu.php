...
<nav class="navbar navbar-default sidebar"  role="navigation" style="z-index: 1;">
  	<div class="container-fluid">
    	<div class="row-fluid">
		 ...
		 <?php if ($_SESSION['usuarioNivelAcesso'] == "1" || $_SESSION['usuarioNivelAcesso'] == "2") { ?>	<li><a href="listar_inscricoes.php?usuarioNivelAcesso=<?php echo $_SESSION[
     'usuarioNivelAcesso'
		 ...
		 <?php if ($_SESSION['usuarioNivelAcesso'] == "1" || $_SESSION['usuarioNivelAcesso'] == "2" || $_SESSION['usuarioNivelAcesso'] == "5") { ?>        <li><a href="selecinaTurmaEstudante.php?usuarioNivelAcesso=<?php echo $_SESSION[
            'usuarioNivelAcesso'
        ]; ?>"> Turmas <span style="font-size:20px;" class="pull-right glyphicon glyphicon-education"></span></a></li> <?php } ?>
		 ...
		 <?php if ($_SESSION['usuarioNivelAcesso'] == "1" || $_SESSION['usuarioNivelAcesso'] == "2" || $_SESSION['usuarioNivelAcesso'] == "5") { ?>       <li><a href="Instrutor-listar.php?usuarioNivelAcesso=<?php echo $_SESSION[
           'usuarioNivelAcesso'
       ]; ?>"> Professores <span style="font-size:20px;" class="pull-right glyphicon glyphicon-user"></span></a></li> <?php } ?>


 <?php if ($_SESSION['usuarioNivelAcesso'] == "0" || $_SESSION['usuarioNivelAcesso'] == "0" || $_SESSION['usuarioNivelAcesso'] == "5") { ?>       <li><a href="Turma.php?usuarioNivelAcesso=<?php echo $_SESSION[
           'usuarioNivelAcesso'
       ]; ?>"> Turmas<span style="font-size:20px;" class="pull-right glyphicon glyphicon-user"></span></a></li> <?php } ?>
       ...
       $_SESSION['usuarioNivelAcesso'] == "5"
		...
		"></span></a></li> <?php } ?>
		        <div id="collapseTwo" class="panel-collapse collapse" >
		        	<ul class="nav navbar-nav">
		            <?php if ($_SESSION['usuarioNivelAcesso'] == "1" || $_SESSION['usuarioNivelAcesso'] == "2") { ?>	<li><a href="Detalhes_Disciplina.php?usuarioNivelAcesso=<?php echo $_SESSION[
     'usuarioNivelAcesso'
 ]; ?>">&nbsp;&nbsp;&nbsp; Disciplina<span style="font-size:20px;" class="pull-right glyphicon glyphicon-pencil"></span></a></li> <?php } ?>
		            <?php if ($_SESSION['usuarioNivelAcesso'] == "" || $_SESSION['usuarioNivelAcesso'] == "" || $_SESSION['usuarioNivelAcesso'] == "5") { ?>	<li><a href="selecinaTurmaMensalidades.php?usuarioNivelAcesso=<?php echo $_SESSION[
     'usuarioNivelAcesso'
 ]; ?>">&nbsp;&nbsp;&nbsp; Mensalidades<span style="font-size:20px;" class="pull-right glyphicon glyphicon-usd"></span></a></li> <?php } ?>
		        	</ul>
		    	</div>
					<?php if ($_SESSION['usuarioNivelAcesso'] == "2" || $_SESSION['usuarioNivelAcesso'] == "3") { ?>    	<li><a href="selecinaTurmaClasse.php?usuarioId=<?php echo $_SESSION[
         'usuarioId'
     ]; ?>">Notas<span style="font-size:20px;" class="pull-right glyphicon glyphicon-list-alt"></span></a></li> <?php } ?>
	 
	 <?php if ($_SESSION['usuarioNivelAcesso'] == "1" || $_SESSION['usuarioNivelAcesso'] == "") { ?>    	<li><a href="selecinaTurmaClasse2.php?usuarioId=<?php echo $_SESSION[
         'usuarioId'
         ...
         'usuarioNivelAcesso'
     ]; ?>">Notas Trimestrais<span style="font-size:20px;" class="pull-right glyphicon glyphicon-list-alt"></span></a></li> <?php } ?>
					...
					<?php if ($_SESSION['usuarioNivelAcesso'] == "" || $_SESSION['usuarioNivelAcesso'] == "") { ?>        <li><a href="https://www.cursoemvideo.com/minha-conta/"<?php echo $_SESSION[
            'usuarioId'
